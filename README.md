...
| 25.02.05 ~ 02.07 | 한국통신학회 동계종합학술발표회  | 논문(Isolation Forest 와 Autoencoder 하이브리드 이상치 탐지 기법을 활용한 산업 전력 데이터 분석 및 최적화) | 논문 제출 |
|  |   | 아이디어 경진대회(생성형 AI를 활용한 실시간 아동 안전 보호 시스템) | 수료증 수여 |
