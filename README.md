...
| 기간       | 활동       | 내용                                  |
|------------|------------|----------------------------------------|
| ~ 25.07.11 | Isolation Forest 와 Autoencoder 하이브리드 이상치 탐지 부분 참여(공저자) | A Comparative Study of Customized Algorithms for Anomaly Detection in Industry-Specific Power Data (SCIE) |
